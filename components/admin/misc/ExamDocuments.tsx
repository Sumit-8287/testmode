          ...
          {isFilterOpen && (
            <div className="absolute right-0 top-full mt-2 w-64 bg-white border border-gray-100 rounded-2xl shadow-xl z-[100] p-4 animate-in fade-in zoom-in duration-200 origin-top-right">
              ...
              <div className="space-y-4">
                <div>
                  <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest block mb-2">Document Status</label>
                  <div className="flex flex-col gap-1">
                    {['all', 'active', 'inactive'].map((status) => (
                      ...
                      >
                        {status === 'all' ? 'All Documents' : status === 'active' ? 'Active Only' : 'Inactive Only'}
                      </button>
                    ))}
                  </div>
                </div>
